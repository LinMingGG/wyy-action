...
if object['code']==200:
    ...
    urlsckey = 'https://sc.ftqq.com/SCU95156T515985ffca658bf1b801c249e3ab77215ea134d35815f.send'
    requests.post(urlsckey, data={"text": "网易云签到提醒", "desp": "刷单成功！共"+str(count)+"首"})
    exit()
else:
